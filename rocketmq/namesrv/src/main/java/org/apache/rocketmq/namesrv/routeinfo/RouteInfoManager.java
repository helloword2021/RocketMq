...
public class RouteInfoManager {
    ...
    private final HashMap<String/* topic */, List<QueueData>> topicQueueTable;//topic brokername 对应关系{"topic1":[{"borkerName":"broker-a","readQueue":4,...}]}
    private final HashMap<String/* brokerName */, BrokerData> brokerAddrTable;//brokername brokerid关系{"broker-a",:{"cluster":"c1","brokerName":"broker-a","brokerAddress":{s100:9000}}}
    private final HashMap<String/* clusterName */, Set<String/* brokerName */>> clusterAddrTable;//集群 brokername {"c1":[{"broker-a"},"broker=b"}]}
    private final HashMap<String/* brokerAddr */, BrokerLiveInfo> brokerLiveTable;//活跃的broker {"192.168.1.108:10000":{"lastupdatetime":"12843343",...}}
...
//创建更新topicQueueTable
    ...
    //如果是topicQueueTable 对应的topic 与其对应的boker 信息为空,则新建一个
...
class BrokerLiveInfo {
    private long lastUpdateTimestamp;//根据最后更新时间 来判断是否是活的
